...
${mssql_pass_line}
    Levantar : sudo bash setup-estudiante-arch/scripts/sqlserver-up.sh
    Detener  : sudo bash setup-estudiante-arch/scripts/sqlserver-down.sh
    Purgar   : sudo bash setup-estudiante-arch/scripts/sqlserver-down.sh --purge
