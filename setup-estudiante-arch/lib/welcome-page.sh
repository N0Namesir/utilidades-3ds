...
<main>
  ...
  <div class="links">
    ...
    <div class="link-card" style="cursor:help">
      <span class="link-icon">🧊</span>
...
PHPEOF
    chown "$REAL_USER":http /var/www/html/index.php
...
verify_welcome_page() {
    verify_check "/var/www/html/index.php existe" "[[ -f /var/www/html/index.php ]]" "..."
    verify_check "index.php usa systemctl is-active" \
        "grep -q 'systemctl is-active mariadb' /var/www/html/index.php" "..."
    verify_check "welcome page sirve HTTP 200" "curl -fsS -o /dev/null http://localhost/" "..."
}
