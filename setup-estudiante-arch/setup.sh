...
# Versión: 2.0 — Junio 2026 — Variante Arch Linux / CachyOS
# Uso: sudo bash setup.sh [--skip-wordpress] [--only=mod1,mod2] [--verify]
#
# Gestor de paquetes:
#   - Repositorios oficiales : pacman -S --noconfirm --needed
#   - AUR                    : yay -S --noconfirm --needed  (como REAL_USER)
# =============================================================================
...
Gestor de paquetes:
  Repositorios oficiales  →  pacman -S --noconfirm --needed
  AUR (sin root)          →  yay -S --noconfirm --needed  (como SUDO_USER)
HELP
            exit 0
            ;;
...
echo "  Arch Linux / CachyOS — $(date '+%Y-%m-%d %H:%M')"
echo "=============================================="
echo ""
...
step "Limpieza final"
pacman -Sc --noconfirm
# Eliminar cachés de versiones antiguas si paccache está disponible (pacman-contrib).
