...
# Antes detiene Apache + MariaDB para liberar RAM (en 4 GB importa).
...
if ! command -v podman &>/dev/null; then
   ...
   Editá setup-estudiante/setup.sh y descomentá la sección de Podman,
...
# --- 4. Liberar RAM ---
info "Deteniendo Apache y MariaDB para liberar RAM..."
systemctl stop apache2  || warn "apache2 no estaba corriendo"
